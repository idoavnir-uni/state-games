...
class MostHatedCityDataset:
    ...
    def _generate_sample(self) -> MostHatedCitySample:
        ...
        for i in range(self.n_entities):
            ...
            sentences.append(f"{name} hates {city}.")
    ...
    def __getitem__(self, idx: int) -> MostHatedCitySample:
