...
% 
% EMPHASIS: Many prior works have focused on improving the *storage* capabilities 
% of SSMs and sub-quadratic models. However, our work investigates whether the 
% bottleneck lies not in storage, but in how models *query* their stored state.
