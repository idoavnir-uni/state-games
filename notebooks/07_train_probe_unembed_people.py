# %% [markdown]
# # State Probing with Unembedding Matrix - Favorite Color
# 
# This notebook:
...
# plt.tight_layout()
# plt.savefig('../data/probe_accuracy_all_positions_people_top1_top3.png', dpi=150)
# plt.show()
...
# plt.tight_layout()
# plt.savefig('../data/probe_accuracy_by_position_people_top1_top3.png', dpi=150)
# plt.show()
...
# plt.grid(True, alpha=0.3)
# plt.tight_layout()
# plt.savefig('../data/probe_accuracy_rolling_window_people_top1.png', dpi=150)
# plt.show()
...
# plt.grid(True, alpha=0.3)
# plt.tight_layout()
# plt.savefig('../data/probe_accuracy_rolling_window_people_top3.png', dpi=150)
# plt.show()
