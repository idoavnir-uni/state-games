...
def run_full_experiment(sample_pairs, hook_name: str):
    ...
    print(f"Original: {results_baseline['original']:3d}/{n_total}, Blue: {results_baseline['blue']:3d}/{n_total}, Neither: {results_baseline['neither']:3d}/{n_total}")
    ...
    print(f"Original: {results_all['original']:3d}/{n_total}, Blue: {results_all['blue']:3d}/{n_total}, Neither: {results_all['neither']:3d}/{n_total}")
...
print(f"  Baseline: orig={baseline_before['original']}, blue={baseline_before['blue']}, neither={baseline_before['neither']}")
...
print(f"  Baseline: orig={baseline_color['original']}, blue={baseline_color['blue']}, neither={baseline_color['neither']}")
...
print(f"  Baseline: orig={baseline_period['original']}, blue={baseline_period['blue']}, neither={baseline_period['neither']}")
...
print(f"Final performance: orig={results_final['original']}, blue={results_final['blue']}, neither={results_final['neither']}")
...
top_probe_heads = [
    (15, 11), (14, 23), (15, 2), (15, 27), (15, 13), (14, 18),
    (9, 18), (15, 1), (15, 1), (15, 8), (12, 24), (17, 18),
    (20, 29), (15, 25), (19, 8), (19, 14), (15, 29), (12, 9),
    (20, 10), (15, 23), (15, 15), (21, 6), (12, 18), (20, 4),
    (19, 21), (16, 26), (19, 5), (11, 21), (19, 9), (14, 2),
    (15, 14), (21, 23), (11, 17), (19, 27), (19, 17), (14, 10),
    (15, 31), (15, 18), (12, 14), (16, 11), (9, 26), (12, 17),
    (21, 5), (21, 2), (19, 31), (14, 27), (13, 7), (16, 17),
    (14, 17), (19, 18), (14, 22)
]
...
top_probe_heads_v2 = [
    (15, 11), (14, 23), (15, 2), (15, 27), (15, 13), (14, 18),
    (15, 8), (12, 24), (15, 1), (9, 18), (17, 18), (20, 29),
    (19, 8), (12, 9), (20, 10), (15, 29), (19, 14), (12, 28),
    (15, 25), (15, 23), (12, 18), (21, 6), (15, 15), (16, 26),
    (20, 4), (19, 21), (14, 2), (15, 14), (19, 5), (11, 21),
    (16, 24), (14, 10), (15, 18), (19, 9), (21, 23), (11, 17),
    (12, 14), (19, 17), (19, 27), (9, 26), (13, 7), (15, 31),
    (16, 11), (21, 5)
]
...
top_probe_heads_v3 = [
    (15, 11), (15, 2), (15, 13), (14, 23), (15, 27), (9, 18),
    (15, 1), (14, 18), (12, 18), (15, 8), (15, 29), (12, 24),
    (15, 15), (12, 28), (15, 22), (12, 9), (11, 21), (15, 31),
    (20, 29), (17, 18), (15, 23), (19, 14), (15, 18), (15, 14),
    (20, 10), (16, 24), (11, 17), (16, 26), (12, 6), (19, 5),
    (21, 6), (20, 4), (15, 25), (19, 21), (14, 17), (13, 7),
    (12, 14), (21, 23), (12, 13), (14, 10), (17, 11)
]
...
print(f"    Original: {results_baseline['original']:2d}/{len(samples_subset_v3)} ({results_baseline['original']/len(samples_subset_v3)*100:.1f}%)")
print(f"    Blue:     {results_baseline['blue']:2d}/{len(samples_subset_v3)} ({results_baseline['blue']/len(samples_subset_v3)*100:.1f}%)")
print(f"    Neither:  {results_baseline['neither']:2d}/{len(samples_subset_v3)} ({results_baseline['neither']/len(samples_subset_v3)*100:.1f}%)")
...
print(f"    Original: {results_selected['original']:2d}/{len(samples_subset_v3)} ({results_selected['original']/len(samples_subset_v3)*100:.1f}%)")
print(f"    Blue:     {results_selected['blue']:2d}/{len(samples_subset_v3)} ({results_selected['blue']/len(samples_subset_v3)*100:.1f}%)")
print(f"    Neither:  {results_selected['neither']:2d}/{len(samples_subset_v3)} ({results_selected['neither']/len(samples_subset_v3)*100:.1f}%)")

print(f"\n[3] ALL HEADS - Every head in every layer ({n_layer} layers × {n_head} heads = {n_layer * n_head} total):")
...
print(f"    Original: {results_all['original']:2d}/{len(samples_subset_v3)} ({results_all['original']/len(samples_subset_v3)*100:.1f}%)")
print(f"    Blue:     {results_all['blue']:2d}/{len(samples_subset_v3)} ({results_all['blue']/len(samples_subset_v3)*100:.1f}%)")
print(f"    Neither:  {results_all['neither']:2d}/{len(samples_subset_v3)} ({results_all['neither']/len(samples_subset_v3)*100:.1f}%)")
