...
for i in range(N_SAMPLES):
    ...
    # Hook point: RIGHT AFTER the color token, BEFORE the period
    # state_A has seen "black", state_B has seen "blue"
    # Then we continue with "." and the rest
    ...
    # We want hook_text to end with "black" (no period)
    # So: prefix + "Lady Gaga's favorite color is " + color
