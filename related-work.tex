...
activations \cite{hewitt2019structural,gurnee2024language,engels2024notall}; recent 'lens' techniques decode intermediate representations into
output distributions, providing a token-level view of how predictions evolve
across depth \cite{belrose2023tunedlens}. Patchscopes unifies several such
inspection methods by patching source representations into a target prompt
designed to elicit their content, effectively using the model itself as a probe
\cite{ghandeharioun2024patchscopes,chen2024selfie}. Beyond correlational probes, causal
