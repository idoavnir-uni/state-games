...
@dataclass
class FavoriteColorSample:
    text: str
    input_ids: Any
    fixed_entity_color: str
    fixed_entity_sentence_end_token_idx: int
    fixed_entity_sentence_number: int


class FavoriteColorDataset:
    def __init__(
        self,
        tokenizer,
        size: int = 1000,
        ...
        if colors is not None:
            ...
            self.colors = DEFAULT_COLORS[:n_colors]
    ...
    def _generate_sample(self) -> FavoriteColorSample:
        fixed_position = random.randint(0, self.n_entities - 1)
        fixed_color = random.choice(self.colors)
        ...
        for i in range(self.n_entities):
            ...
            sentences.append(f"{name}'s favorite color is {color}.")
        ...
        return FavoriteColorSample(
            text=text,
            input_ids=input_ids,
            fixed_entity_color=fixed_color,
    ...
    def __getitem__(self, idx: int) -> FavoriteColorSample:
    ...
    def get_sample_info(self, idx: int) -> Dict[str, Any]:
        ...
        return {
            ...
            "fixed_entity_color": sample.fixed_entity_color,
